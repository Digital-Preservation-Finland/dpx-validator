...
class DpxValidator():
    ...
    def __init__(self, file_handle, path):
    ...
    def check_offset_to_image(self, field=None, path=None) -> None:
        """
    ...
    def check_version(self, field=None) -> str:
        """
    ...
    def check_filesize(self, field=None, path=None) -> str:
        """
    ...
    def check_unencrypted(self, field=None) -> None:
        """
    ...
    def check_truncated(path,
        ...
        return stat(path).st_size < last_field["offset"] +\
            calcsize(last_field["data_form"])
    ...
    def run_basic_procedures(self, cut_on_error=False) -> tuple[bool, list]:
        """
